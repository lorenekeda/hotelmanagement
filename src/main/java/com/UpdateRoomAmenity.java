...
@WebServlet("/updateRoomAmenity")
public class UpdateRoomAmenity extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean updateSuccess = RoomService.updateRoomAmenity(hotelId, chainId,roomNum, amenity);

            if (updateSuccess) {
                request.setAttribute("message", "Room Amenity updated successfully!");
        ...
        request.getRequestDispatcher("changeamenity.jsp").forward(request, response);
    }
