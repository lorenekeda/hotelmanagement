...
<head>
  ...
  <title>Update Room Amenity Information</title>
</head>
<body>
<h2>Update Room Amenity Information</h2>
<% if (request.getAttribute("message") != null) { %>
<div class="message ${messageType}">
  <%= request.getAttribute("message") %>
</div>
<% } %>
<form action="updateRoomAmenity" method="post">
  ...
  <button type="submit">Update Room Amenity</button>
