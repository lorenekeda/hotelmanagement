...
<head>
  ...
  <title>Delete Room Damage Information</title>
</head>
<body>
<h2>Delete Room Damage Information</h2>
<% if (request.getAttribute("message") != null) { %>
<div class="message ${messageType}">
  <%= request.getAttribute("message") %>
</div>
<% } %>
<form action="deleteRoomDamage" method="post">
  ...
  <input type="text" id="damage" name="damage" required><br>



  <button type="submit">Delete Room Damage</button>
