...
<head>
  ...
  <title>Add Room Damage Information</title>
</head>
<body>
<h2>Add Room Damage Information</h2>
<% if (request.getAttribute("message") != null) { %>
<div class="message ${messageType}">
  <%= request.getAttribute("message") %>
</div>
<% } %>
<form action="addRoomDamage" method="post">
  ...
  <button type="submit">Add Room Damage</button>
